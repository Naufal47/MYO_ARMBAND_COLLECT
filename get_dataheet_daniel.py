...
# --------------------------------------------------------------------------------------
ser = serial.Serial('com21',baudrate=2000000)
data = []
...
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    data2.to_csv('a_sudut6.csv', index=False) #<------------NAMA FILE FLEX----------
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    print(len(data2))
...
class Plot(object):
    ...
    def update_plot(self):
        ...
        # $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
        save_emgTranspose.to_csv('a_myo6.csv',index=False) #<--------NAMA FILE EMG----
        # $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
